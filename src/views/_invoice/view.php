...
$this->params['buttons'] = [
    ['label' => Yii::t('billing/billing/buttons', 'invoice_buttons.view.update_invoice'), 'url' => ['update', "id" => $model->id], 'linkOptions' => ["class" => "showModalButton btn btn-sm btn-primary", "title" => Yii::t('billing/billing/titles', 'invoice_titles.update_invoice')]],
    ['label' => Yii::t('billing/billing/buttons', 'invoice_buttons.view.delete_invoice'), 'url' => ['delete', "id" => $model->id], 'linkOptions' => ["class" => "btn btn-sm btn btn-danger", "title" => Yii::t('billing/billing/titles', 'invoice_titles.delete_invoice'),
    'data' => [
...
?>
<div class="billing-view col-md-12">
